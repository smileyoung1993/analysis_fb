...
#
# def ex9():
#     fig, subplot = plt.subplot(1, 1)
#
#     subplot.plot(randn(50).cumsum(), color='black', linestyle = 'dashed', label='AAA')
#     subplot.plot(randn(50).cumsum(), color='blue' , drawstyle = 'steps-mid', label='BBB')
#
#     plt.legend(loc = 'best')
#
#
